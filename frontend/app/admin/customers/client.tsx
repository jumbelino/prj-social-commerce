  ...
  return (
    <div className="space-y-5">
      <section className="rounded-3xl border border-[var(--color-line)] bg-[var(--color-card)] px-5 py-7 shadow-[0_14px_36px_rgba(18,30,40,0.08)] sm:px-8">
        ...
        <h1 className="mt-3 font-display text-4xl leading-tight text-[var(--color-text)]">Clientes</h1>
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          <input
            ...
            className="rounded-lg border border-[var(--color-line)] bg-[var(--color-surface-1)] text-[var(--color-text)] px-3 py-2 text-sm placeholder:text-[var(--color-muted)] focus:border-[var(--color-accent)] focus:outline-none"
          />
        </div>
      </div>
